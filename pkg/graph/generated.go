...
type ComplexityRoot struct {
	...
	Mutation struct {
		Create  func(childComplexity int, referenceID string, payload string) int
		Delete  func(childComplexity int, payload string) int
		Refresh func(childComplexity int, accessToken string, refreshToken string) int
	}

	Query struct {
		Get func(childComplexity int, token string) int
	}
}

type MutationResolver interface {
	Create(ctx context.Context, referenceID string, payload string) (*auth.Auth, error)
	Refresh(ctx context.Context, accessToken string, refreshToken string) (*auth.Auth, error)
	Delete(ctx context.Context, payload string) (*auth.Auth, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.create":
		...
		return e.complexity.Mutation.Create(childComplexity, args["reference_id"].(string), args["payload"].(string)), true
	...
	case "Mutation.delete":
		...
		return e.complexity.Mutation.Delete(childComplexity, args["payload"].(string)), true
	...
	case "Mutation.refresh":
		...
		return e.complexity.Mutation.Refresh(childComplexity, args["access_token"].(string), args["refresh_token"].(string)), true
	...
	case "Query.get":
		...
		return e.complexity.Query.Get(childComplexity, args["token"].(string)), true
...
func (ec *executionContext) field_Mutation_create_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	var arg0 string
	if tmp, ok := rawArgs["reference_id"]; ok {
...
func (ec *executionContext) _Auth_access_token(ctx context.Context, field graphql.CollectedField, obj *auth.Auth) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
...
func (ec *executionContext) _Auth_refresh_token(ctx context.Context, field graphql.CollectedField, obj *auth.Auth) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Mutation_create(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().Create(rctx, args["reference_id"].(string), args["payload"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalNAuth2ᚖgithubᚗcomᚋrodrwanᚋgoᚑauthᚑsvcᚐAuth(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_refresh(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().Refresh(rctx, args["access_token"].(string), args["refresh_token"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_delete(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().Delete(rctx, args["payload"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_get(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Get(rctx, args["token"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Auth(ctx context.Context, sel ast.SelectionSet, obj *auth.Auth) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "refresh_token":
			out.Values[i] = ec._Auth_refresh_token(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		default:
...
func (ec *executionContext) marshalNAuth2githubᚗcomᚋrodrwanᚋgoᚑauthᚑsvcᚐAuth(ctx context.Context, sel ast.SelectionSet, v auth.Auth) graphql.Marshaler {
	return ec._Auth(ctx, sel, &v)
}

func (ec *executionContext) marshalNAuth2ᚖgithubᚗcomᚋrodrwanᚋgoᚑauthᚑsvcᚐAuth(ctx context.Context, sel ast.SelectionSet, v *auth.Auth) graphql.Marshaler {
	if v == nil {
